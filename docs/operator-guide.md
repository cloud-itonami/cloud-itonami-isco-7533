...
- safety-critical escalation path (needle-puncture hazard,
  moving-machine-part hazard, equipment condition)
...
- a hard, unconditional block on any attempt to route a
  sewing/embroidery-execution decision, a workshop-safety-clearance
  decision, or a shop-safety-officer override decision, through this
  actor — those decisions stay the shop safety officer's exclusive
...
sewing/embroidery-execution decision, a workshop-safety-clearance
decision, or a shop-safety-officer judgment override through this
actor.
